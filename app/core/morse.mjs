...
export const SIGNAL_FREQUENCIES=Object.freeze([1800,18000,19000,20000,21000,22000]);
export const DEFAULT_SIGNAL_FREQUENCY=SIGNAL_FREQUENCIES[0];
export function validateTiming({wpm = 40, frequency = 700, volume = 0.25, experimental = false, highFrequency = false, sampleRate = 48000} = {}) {
  ...
  const maximum=experimental&&highFrequency?SIGNAL_FREQUENCIES.at(-1):experimental?4000:1200;
